      ...
      <li class="list-group-item media col-md-6" style="margin-top: 0px;">
        ...
        <div class="avatar pull-left">
          <a href="{{ route('users.show', [$topic->user_id]) }}">
            <img class="media-object img-thumbnail avatar avatar-middle" alt="{{ $topic->user->name }}"
        ...
        <div class="infos">
          ...
          <div class="media-heading">
            ...
            @else
              <span
                class="hidden-xs label label-{{ ($topic->is_excellent == 'yes' && Route::currentRouteName() != 'home') ? 'success' : 'default' }}">{{ $topic->category->name }}</span>
            @endif
