    ...
    <div class="main-col col-md-9 left-col">
      ...
      <div class="panel panel-default padding-md">
        ...
        <div class="panel-body ">
          ...
          <form class="form-horizontal" method="POST" action="{{ route('users.update_email_notify', $user->id) }}"
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="checkbox" class="bootstrap-switch"
                       name="email_notify_enabled" {{ $user->email_notify_enabled == 'yes' ? 'checked' : '' }}>
              </div>
            </div>
            <br>
            <br>
            ...
            <div class="form-group">
              <div class="col-sm-offset-2 col-sm-10">
                <input class="btn btn-primary btn-lg" id="user-edit-submit" type="submit"
