<div class="box">
  ...
  <div class="padding-sm user-basic-info">
          ...
          @if ($user->present()->hasBadge())
            <div class="role-label">
              <a class="label label-success role"
                 href="{{ route('roles.show', [$user->present()->badgeID()]) }}">{{ $user->present()->badgeName() }}
                }</a>
            </div>
          @endif
          ...
          <div class="item">
            ...
            @if ($user->gender == 'male')
              ...
              <svg width="14" height="16" viewBox="0 0 14 14" class="Icon Icon--male" aria-hidden="true"
                   style="height: 16px; width: 14px;fill:#9fadc7;top: 2px;position: relative;"><title></title>
                <g>
                  <path
            ...
            @elseif($user->gender == 'female')
              ...
              <svg width="14" height="16" viewBox="0 0 12 16" class="Icon Icon--female" aria-hidden="true"
                   style="height: 16px; width: 14px;fill: #e89090;top: 2px;position: relative;"><title></title>
                <g>
                  <path
    ...
    <div class="follow-info row">
      ...
      <div class="col-xs-4">
        <a class="counter"
           href="{{ route('users.replies', $user->id) }}">{{ $user->reply_count +  $user->topic_count}}</a>
      ...
      <ul class="list-inline">
        ...
        @if ($user->twitter_account)
          <li class="popover-with-html" data-content="{{ $user->twitter_account }}">
            <a href="https://twitter.com/{{ $user->twitter_account }}" rel="nofollow" class="twitter" target="_blank"><i
        ...
        @if ($user->linkedin)
          <li class="popover-with-html" data-content="点击查看 LinkedIn 个人资料">
            <a href="{{ $user->linkedin }}" rel="nofollow" class="linkedin" target="_blank"><i
        ...
        @if ($user->company)
          <li class="popover-with-html" data-content="{{ $user->company }}"><i
              class="fa fa-users"></i> {{ lang('Company') }}
          </li>
        @endif

        @if ($user->city)
          <li class="popover-with-html" data-content="{{ $user->city }}"><i
              class="fa fa-map-marker"></i> {{ lang('City') }}
          </li>
        @endif
