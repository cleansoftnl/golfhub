    ...
    <div class="row footer-top">
      ...
      <div class="col-sm-5 col-lg-5">
        ...
        <div class="text-md ">
          ...
          <a class="popover-with-html" data-content="关注「Laravel资讯」" target="_blank" style="padding-right:8px"
             href="http://weibo.com/laravelnews"><i class="fa fa-weibo" aria-hidden="true"></i></a>
          <a class="popover-with-html" data-content="扫码关注微信订阅号：「Laravel资讯」" target="_blank" style="padding-right:8px"
