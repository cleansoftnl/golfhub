          ...
          <div class="panel-body remove-padding-horizontal notification-index">
            ...
            <ul class="list-group row">
              @foreach($threads as $thread)
                ...
                <li class="list-group-item media {{ $unread_messagesCount > 0 ? 'unread' : '' }}"
                  ...
                  <div class="avatar pull-left">
                    <a href="{{ route('users.show', [$participant->id]) }}">
                      <img class="media-object img-thumbnail avatar" alt="{{ $participant->name }}"
                           src="{{ $participant->present()->gravatar }}" style="width:48px;height:48px;"/>
                    </a>
                  </div>
                    ...
                    <div class="media-heading">
                      ...
                      <a href="{{ route('users.show', [$participant->id]) }}">
                        {{ $participant->name }}
                            ...
                            <span class="meta">
                                 ⋅ {{ lang('at') }} ⋅ <span
                                class="timeago">{{ $thread->latestMessage->created_at }}</span>
                            </span>：
                    </div>
