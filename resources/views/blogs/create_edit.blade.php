      ...
      <div class="panel-body ">
        ...
        @if ($blog->id > 0)
          <form class="form-horizontal" method="POST" action="{{ route('blogs.update', $blog->id) }}"
                accept-charset="UTF-8" id="topic-create-form" enctype="multipart/form-data">
            <input name="_method" type="hidden" value="PATCH">
            @else
              <form class="form-horizontal" method="POST" action="{{ route('blogs.store') }}" accept-charset="UTF-8"
                    id="topic-create-form" enctype="multipart/form-data">
                @endif
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input class="form-control" name="slug" type="text" value="{{ old('slug') ?:$blog->slug }}"
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="file" name="cover"
                           {{ $blog->cover ? '' : 'required' }} value="{{ old('cover') ?: $blog->cover }}">
                ...
                <div class="form-group">
                  <div class="col-sm-offset-2 col-sm-6">
                    <input class="btn btn-primary" id="user-edit-submit" type="submit"
                           value="{{ lang('Apply Changes') }}">
                  </div>
                </div>
              </form>
      </div>
