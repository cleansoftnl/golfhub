...
@section('header')
  <div class="page-header clearfix">
    <h1>
      ...
      <a class="btn btn-success pull-right" href="{{ route('blogs.create') }}"><i class="glyphicon glyphicon-plus"></i>
        Create</a>
    </h1>
        ...
        <table class="table table-condensed table-striped">
          ...
          @foreach($blogs as $blog)
            <tr>
              ...
              <td class="text-right">
                <a class="btn btn-xs btn-primary" href="{{ route('blogs.show', $blog->id) }}"><i
                    class="glyphicon glyphicon-eye-open"></i> View</a>
                <a class="btn btn-xs btn-warning" href="{{ route('blogs.edit', $blog->id) }}"><i
